        ...
        SendVerificationCodeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(phoneNumber)){
                    ...
                    loadingBar.setMessage("plesae wait.We r authenticating ur phone no.");
        ...
        VerifyButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(verificationCode)){
                    Toast.makeText(PhoneLoginActivity.this, "plz write verification code", Toast.LENGTH_SHORT).show();
                }
                else {

                    loadingBar.setTitle("Code Verification");
                    loadingBar.setMessage("plesae wait.We r authenticating ur verification code.");
                    loadingBar.setCanceledOnTouchOutside(false);
                    loadingBar.show();
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            loadingBar.dismiss();
                            Toast.makeText(PhoneLoginActivity.this, "Congrat. Loggin n!", Toast.LENGTH_SHORT).show();
